...
export const ReadySection: React.FC = () => {
  return (
    <Row justify="center" style={{ background: "var(--gray-primary)", borderRadius: 16, padding: 20 }}>
      <Col md={{ span: 20 }}>
        ...
        <Typography.Paragraph style={{ textAlign: "center", marginBottom: 30, fontSize: 14 }}>
          Get started with Mega-Med today. Prepare for your medical entrance exams with Mega-Med. Take tests, talk to mentors, and track
          your progress. Join us and succeed in your medical career.
